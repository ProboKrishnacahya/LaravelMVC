...
@section('main_content')
    <div class="d-md-flex justify-content-md-end">
        <a href="{{ route('project.create') }}"><i class="bi bi-plus-lg"></i>
            <button class="btn btn-success my-3" type="button">
                &emsp;Create</button>
        </a>
    </div>
    <br>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex gap-2 justify-content-center">
                            <a class="btn btn-info" href="{{ route('project.show', $pro->code) }}">
                            ...
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-outline-danger" onclick = "return confirm('Are you sure you want to delete the data?\nThis action cannot be undone!');">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
